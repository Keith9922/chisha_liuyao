// 真 SVG 图标(Lucide 风格,1.75 描边)。纯装饰,aria-hidden;语义由相邻文字承载。
...
export const icons = {
  ...
  star: (): string => wrap('<path d="M12 3l2.6 5.3 5.9.9-4.3 4.1 1 5.8L12 16.9 6.8 19.1l1-5.8L3.5 9.2l5.9-.9L12 3Z"/>'),
  refresh: (): string =>
    wrap('<path d="M3 12a9 9 0 0 1 15.5-6.4L21 8"/><path d="M21 3v5h-5"/><path d="M21 12a9 9 0 0 1-15.5 6.4L3 16"/><path d="M3 21v-5h5"/>'),
  compass: (): string => wrap('<circle cx="12" cy="12" r="9"/><path d="M15.5 8.5l-2 5-5 2 2-5 5-2Z"/>'),
  utensils: (): string =>
